...
public partial class MainWindow : Window
{
    ...
    private async Task<BasicSpeechObject?> CaptureSpeechAsync(string sourceLanguage)
    {
        try
        {
            ...
            // determined the sampling frequency and the precision from the device and
            // recorded them; building a fresh Qualifier to hold the language alone
            // discarded that, leaving raw headerless PCM with nothing to describe it.
            // The language is added to the Qualifier that came with the capture.
